...
const MainForm = () => {
    ...
    return (
        <div className="px-5 py-5 shadow bg-white text-dark border rounded row border-info">
            <form onSubmit={handleSubmit}>
                <div className="form-group mb-4">
                    <h2 className="text-info mb-4">THE ULTIMATE CHATCLUB</h2>
                </div>
                <div className="form-group mb-4">
                ...
                <div className="form-group mb-4">
                    <select className="form-select bg-light" name="room" aria-label="Default select example" onChange={handleChange}>
                        ...
                        <option value="movie">MovieWeeb Zone</option>
                        <option value="coding">Coding Zone </option>
                        <option value="socialMedia">Content Creator Zone</option>
                        <option value="politics">Political Zone</option>
                        <option value="music">Musical Zone </option>
                    </select>
                </div>

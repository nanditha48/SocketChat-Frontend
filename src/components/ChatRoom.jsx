...
const ChatRoom = () => {
    ...
    }, [socket, allMessages, location.state.room]);    
    ...
    return (
        <div className="py-4 m-5 w-50 shadow bg-white text-dark border rounded container light-blue-bg">
            <div className="text-center px-3 mb-4 text-capitalize">
                <h1 className="text-info mb-4">{data?.room} Chat Room</h1>
            </div>
            ...
            <div className="form-group d-flex">
                ...
                <button type="button" className="btn btn-info mx-2" disabled={loading} onClick={onSubmit}>
                    {loading ? (
